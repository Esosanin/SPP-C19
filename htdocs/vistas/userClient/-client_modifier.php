        ...
        if($res['idUsuario'] == $_SESSION['id']){
            ...
            if(!$res){
                ...
                if(!$res){
                    ...
                    $_SESSION['image'] = $dato;
                    header("Location: -client_self.php");
                    exit;
                }
            }
        }else{
                    ...
                    <form method="post" name="editar" enctype="multipart/form-data">
                        <table clase="table" width="75%" align="center" cellspacing="3" cellpadding="20">
                            ...
                            <tr>
                                ...
                                <td></td>
                                <td colspan="3"><label for="apellido"><strong>Apellido: </strong></label><input name="apellido" class="form-control" type="text" placeholder="Su apellido" value="<?php echo $_SESSION['lname'];?>"  maxlength="50" required></td>
                            </tr>
                            <!-- Dirección -->
                            <tr>
                            ...
                            <tr>
                                ...
                                <td></td>
                                <td colspan="3"><label for="direccion-numero"><strong>Numero: </strong></label><input name="num" class="form-control" type="text" placeholder="Numero exterior de su hogar." value="<?php echo $_SESSION['num'];?>"  maxlength="3" required></td>
                            </tr>
                            <!-- Descripción -->
                            <tr>
                                ...
                                <td></td>
                                <td colspan="3"><label for="colonia_cliente"><strong>Colonia: </strong></label><input name="col" class="form-control" type="text" placeholder="Colonia." value="<?php echo $_SESSION['col'];?>"  maxlength="50" required></td>
                            </tr>
                            <tr>
                                ...
                                <td></td>
                                <td colspan="3"><label for="correo_tienda"><strong>Email: </strong></label><input name="email" class="form-control" type="text" placeholder="Correo electronico." value="<?php echo $_SESSION['email'];?>" maxlength="50" required></td>
                            </tr>
                            <tr>
                            </tr>
                            <tr>
                                <td colspan="2"><label for="usuario"><strong>Usuario: </strong></label><input name="user" class="form-control" type="text" placeholder="Nombre de usuario. (Apodo)" value="<?php echo $_SESSION['user'];?>" maxlength="35" required></td>
                                <td></td>
                                <td colspan="3"><label for="contraseña"><strong>Contraseña: </strong></label><input name="pass" class="form-control" type="password" placeholder="Contraseña" value="<?php echo base64_decode($_SESSION['pass']);?>"  maxlength="32" required></td>
                            </tr>
                            <tr>
                                <td></td>
                            </tr>
                            ...
                            <tr>
                                <td colspan="2" align="left"><input class="btn btn-danger" type="button" onclick="window.location='-client_self.php'" value="Cancelar"></td>
                                <td></td>
