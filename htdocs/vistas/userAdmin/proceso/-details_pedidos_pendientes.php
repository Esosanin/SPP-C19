<?php
$query = "SELECT DISTINCT PEDIDO.* FROM PEDIDO, PEDIDOCARRITO WHERE PEDIDO.idCliente = PEDIDOCARRITO.idCliente AND PEDIDO.idTienda = PEDIDOCARRITO.idTienda AND PEDIDO.estatus = 1 AND PEDIDOCARRITO.idTienda = '$idTienda'";
                ...
                <tr align="center">
                    ...
                    <td align="center">
                        ...
                        <form method="POST" name="aceptar">
                            <input id="idPedido" name="idPedido" style="display:none" value="<?php echo $array[$row['idPedido']]['idPedido'];?>">
