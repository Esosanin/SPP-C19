...
$query = "SELECT DISTINCT PEDIDOCARRITO.*, PRODUCTO.nombre FROM PEDIDO, PEDIDOCARRITO, PRODUCTO WHERE PEDIDO.idCliente = PEDIDOCARRITO.idCliente AND PRODUCTO.idProducto = PEDIDOCARRITO.idProducto AND PRODUCTO.idAdmTienda = PEDIDOCARRITO.idTienda AND PEDIDOCARRITO.idCliente = '$idCliente' AND PEDIDOCARRITO.idTienda = '$id'";
