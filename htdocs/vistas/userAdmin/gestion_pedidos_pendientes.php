...
if(isset($_POST['aceptar'])){
    ...
    include "../db.php";
    include "proceso/-aceptar_pedido.php";
    mysqli_close($con);
}
...
<body style="display: flex; flex-direction: column;">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card-body d-flex justify-content-between align-items-center">
               <a href="gestion_pedidos.php"><button class="btn btn-info">Lista de pedidos</button></a>
            </div>
        </div>
    </div>
    ...
    <div style="width:100%;  flex-grow: 1;"  class="row col-center">
        <div class="col-md-7 col-center">
            <div class="card-body d-flex justify-content-between align-items-center">
                <h5>Lista de pedidos pendientes</h5>
            </div>
            <div class="card-body d-flex justify-content-between align-items-center">
                <font size="2">
                <table style="width:100%; height:50%;" class="table table-hover" id="tabla">
                    <tr align="center">
                        <th>ID</th>
                        <th>ID cliente</th>
                        <th>Precio</th>
                    ...
                    <?php
                        include 'proceso/-details_pedidos_pendientes.php';
                    ?>
                </table>
                </font>
            </div>
            ...
            <div class="card-body d-flex justify-content-between align-items-center">
                ...
                <table class="table table-hover" id="productos">
                    ...
                    <?php
                        if($valor){
                            include "../db.php";
                            include "proceso/-details_productos_pendientes.php";
                        }
                    ?>
                </table>
                </font>
