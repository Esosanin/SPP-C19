...
<div class="collapse navbar-collapse" id="navbarResponsive">
    <ul class="navbar-nav ml-auto">
        ...
        <li <?php echo $cs?>>
            <a class="nav-link" href="vistas/userClient/-client_self.php">Perfíl<?php echo $mss;?></a>
        </li>
        <li <?php echo $cc?>>
            <a class="nav-link" href="vistas/userClient/carrito.php">Carrito<?php echo $ccs;?></a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="vistas/-sesion_off.php">Cerrar sesion</a>
        </li>
    </ul>
</div>